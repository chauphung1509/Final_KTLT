# Form implementation generated from reading ui file 'C:\Users\Nicolee\Coding\Final_KTLT\USER_INTERFACE\MainWindowAdmin.ui'
#
...
"")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Users\\Nicolee\\Coding\\Final_KTLT\\USER_INTERFACE\\../RESOURCE/ICON/adm.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"color: rgb(155, 159, 162);")
        icon1 = QtGui.QIcon()
        icon1.addPixmap(QtGui.QPixmap("C:\\Users\\Nicolee\\Coding\\Final_KTLT\\USER_INTERFACE\\../RESOURCE/ICON/vendor1.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
...
"")
    ...
    def retranslateUi(self, MainWindow):
        ...
        self.pushButtonVendor.setText(_translate("MainWindow", "  Vendor"))
        self.pushButtonImport.setText(_translate("MainWindow", "  Import"))
        self.pushButtonReceipt.setText(_translate("MainWindow", " Good rec."))
        ...
        self.pushButtonNew.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#ff2090;\">New</span></p></body></html>"))
        self.pushButtonEdit.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#35b6e8;\">Edit</span></p></body></html>"))
        self.pushButtonDelete.setToolTip(_translate("MainWindow", "<html><head/><body><p><span style=\" font-size:12pt; color:#0581f9;\">Delete</span></p></body></html>"))
        self.pushButtonExcel.setText(_translate("MainWindow", "EXPORT EXCEL"))
        self.groupBox_2.setTitle(_translate("MainWindow", "Search "))
        self.lineEdit.setPlaceholderText(_translate("MainWindow", "*Search term"))
        ...
        self.comboBox.setItemText(3, _translate("MainWindow", "Position"))
        ...
        self.label_5.setText(_translate("MainWindow", "Hi Admin!"))
