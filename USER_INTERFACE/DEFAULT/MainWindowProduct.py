...
"background-color: rgb(242, 248, 255)")
        icon = QtGui.QIcon()
        icon.addPixmap(QtGui.QPixmap("C:\\Users\\Nicolee\\Coding\\Final_KTLT\\USER_INTERFACE\\DEFAULT\\../../RESOURCE/ICON/album.png"), QtGui.QIcon.Mode.Normal, QtGui.QIcon.State.Off)
